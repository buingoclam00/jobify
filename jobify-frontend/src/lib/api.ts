...
export const applicationsApi = {
  ...
  checkExistingApplication: (userId: string, jobPostId: string) =>
    api.get(`/applications/check-existing?userId=${userId}&jobPostId=${jobPostId}`),
...
export const applicationApi = {
  ...
  getUserApplications: (userId: string, params: any = {}) => api.get(`/applications/user/${userId}`, { params }),
  getJobApplications: (jobId: string, params: any = {}) => api.get(`/applications/job-post/${jobId}`, { params }),
  updateApplicationStatus: (id: string, status: string) => api.patch(`/applications/${id}/status`, { status }),
  deleteApplication: (id: string) => api.delete(`/applications/${id}`),
  checkExistingApplication: (jobId: string, userId: string) => api.get(`/applications/check-existing?jobPostId=${jobId}&userId=${userId}`),
};
