  ...
  ({
    ...
    return (
      <div className={cn('space-y-1', className)} ref={ref} {...props}>
        ...
        <div className="relative z-10 multi-select-container" ref={containerRef}>
          {/* Trigger */}
          <div
            id={selectId}
            className={cn(
          ...
          {/* Dropdown */}
          {isOpen && (
            <div className="absolute z-[9999] w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-hidden multi-select-dropdown">
              {searchable && (
