...
const Navbar = () => {
  ...
  const userMenuItems = [
    ...
    { href: '/saved-jobs', label: 'Việc làm đã lưu', icon: Heart },
    { href: '/applications', label: 'Đơn ứng tuyển', icon: FileText },
    { href: '/settings', label: 'Cài đặt', icon: Settings },
  ];

  const companyMenuItems = [
    { href: '/profile', label: 'Hồ sơ công ty', icon: Building2 },
  ...
  const adminMenuItems = [
    ...
    { href: '/admin/jobs', label: 'Quản lý việc làm', icon: FileText },
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xs text-gray-500">
                      {userType === UserRole.COMPANY ? 'Nhà tuyển dụng' :
                        userType === UserRole.ADMIN ? 'Quản trị viên' : 'Ứng viên'}
                    </div>
                  </div>
                </button>
              ...
              <div className="space-y-4">
                ...
                {isAuthenticated ? (
                  ...
                  <div className="space-y-2 px-4">
                    ...
                    <Link href="/register?type=company" onClick={() => setIsMenuOpen(false)}>
